...
/** @constructor */
function $c_Llobos_Add$() {
  $c_O.call(this)
}
$c_Llobos_Add$.prototype = new $h_O();
$c_Llobos_Add$.prototype.constructor = $c_Llobos_Add$;
/** @constructor */
function $h_Llobos_Add$() {
  /*<skip>*/
}
$h_Llobos_Add$.prototype = $c_Llobos_Add$.prototype;
$c_Llobos_Add$.prototype.init___ = (function() {
  return this
});
$c_Llobos_Add$.prototype.add__I__I__I = (function(a, b) {
  return ((a + b) | 0)
});
$c_Llobos_Add$.prototype.$$js$exported$meth$add__I__I__O = (function(a, b) {
  return this.add__I__I__I(a, b)
});
$c_Llobos_Add$.prototype.add = (function(arg$1, arg$2) {
  var prep0 = $uI(arg$1);
  var prep1 = $uI(arg$2);
  return this.$$js$exported$meth$add__I__I__O(prep0, prep1)
});
var $d_Llobos_Add$ = new $TypeData().initClass({
  Llobos_Add$: 0
}, false, "lobos.Add$", {
  Llobos_Add$: 1,
  O: 1
});
$c_Llobos_Add$.prototype.$classData = $d_Llobos_Add$;
var $n_Llobos_Add$ = (void 0);
function $m_Llobos_Add$() {
  if ((!$n_Llobos_Add$)) {
    $n_Llobos_Add$ = new $c_Llobos_Add$().init___()
  };
  return $n_Llobos_Add$
}
$e.lobos = ($e.lobos || {});
$e.lobos.Add = $m_Llobos_Add$;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
